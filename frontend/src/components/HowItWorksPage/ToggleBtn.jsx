  ...
  return (
    <StyledWrapper>
      <label className="switch" aria-label="Toggle Filter">
        <input type="checkbox" checked={activeTab === 'Parents'} readOnly />
        <span onClick={() => handleToggle('Tutor')}>Tutors</span>
        <span onClick={() => handleToggle('Parents')}>Parents/Students</span>
      </label>
    </StyledWrapper>
  );
};
