...
import Navbar from "../Navbar/Navbar"; // 👈 make sure path is correct
        ...
        <div className="relative w-full max-w-5xl mx-auto">
          ...
          */}
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-6 md:gap-8 items-end">
            {/* Left card: no rotation on small screens, rotated on larger screens */}
            <div className="flex flex-col items-center transform rotate-0 sm:-rotate-12 md:-rotate-4 transition-all duration-500 xl:hover:rotate-0 xl:hover:scale-110 lg:-rotate-4">
            ...
            {/* Middle (featured) card: no translate on smallest screens, translate on sm/md */}
            <div className="flex flex-col items-center transform translate-y-0 sm:-translate-y-8 md:-translate-y-16 transition-all duration-500 pt-3 hover:translate-y-0 hover:scale-110">
              <div className="bg-gradient-to-br from-gray-800 to-black rounded-xl p-4 sm:p-6 shadow-2xl border border-yellow-600/30 w-full">
                <img
            ...
            {/* Right card: no rotation on small screens, rotated on larger screens */}
