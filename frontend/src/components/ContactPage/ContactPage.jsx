                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className={`mt-2 w-full rounded-xl border px-4 py-3 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 ${
      ...
      {toast && (
        <div
          className={`fixed left-1/2 -translate-x-1/2 bottom-8 z-50 px-4 py-2 rounded-full text-sm flex items-center gap-2 shadow-lg ${
            toast.kind === "error" ? "bg-rose-500 text-white" : "bg-black text-white"
          }`}
        >
          {toast.kind === "success" ? (
  ...
  return (
    <div className={`rounded-2xl p-4 border border-gray-100 bg-gradient-to-r ${accentBg} shadow-lg`}>
      <div className="flex items-start gap-4">
        <div className="p-3 rounded-lg bg-white/90 backdrop-blur">{icon}</div>
