...
import { transactionItemStyles } from '../assets/dummyStyles'; // Import styles
...
const TransactionItem = ({
  ...
  return (
    <div
      className={transactionItemStyles.container(isEditing, classes)}
    >
          ...
          {isEditing ? (
            <>
              <input
                ...
                aria-describedby={`desc-error-${transaction.id}`}
              />
              {errors.description && (
                <p
          ...
          {isEditing ? (
            <>
              <input
                ...
                className={transactionItemStyles.amountInput(!!errors.amount, classes)}
                aria-invalid={!!errors.amount}
                aria-describedby={`amt-error-${transaction.id}`}
              />
              {errors.amount && (
                <p
